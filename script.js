...
function checkWinner() {
    ...
    if (userChoice === computerChoice) {
        ...
        mySc.classList.add('score-highlight');
        setTimeout(() => mySc.classList.remove('score-highlight'), 300);
        winner.innerText = 'Nyertél!'
    }
    else {
        enemyPoint += 1;
        enemySc.innerText = enemyPoint;
        enemySc.classList.add('score-highlight');
        setTimeout(() => enemySc.classList.remove('score-highlight'), 300);
